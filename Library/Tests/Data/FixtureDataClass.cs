...
{
    /// <summary>
    /// Collection of 11 books representing various genres, authors, and publisher types, 
    /// including fiction, technical literature, and educational materials.
    /// </summary>
    ...
    /// <summary>
    /// Collection of 10 reader records representing students, with realistic names, 
    /// contact details, and registration dates for testing library operations.
    /// </summary>
    ...
    /// <summary>
    /// Collection of 11 loan records representing realistic book borrowing scenarios, 
    /// including various issue dates, loan terms, and associations between readers and books.
    /// </summary>
    public List<LoanRecord> LoanRecords =>
    [
        new LoanRecord
        {
            Id = 1,
